...
input group "=== Lot sizing (any balance starts 0.01; +0.01 per $300) ==="
input double            InpLotPer300         = 0.01;
...
//+------------------------------------------------------------------+
//| Lot: any balance -> 0.01; every extra $300 adds 0.01               |
//+------------------------------------------------------------------+
double LotSize()
  {
   ...
   if(balance <= 0.0)
      return(0.0);
   int steps = (int)MathFloor(balance / 300.0);
